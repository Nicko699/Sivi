...
import { crearMarca } from "../../../Services/MarcaServiceP/MarcaService";
import Swal from "sweetalert2";

export function CrearMarca({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (mensajeBackend.toLowerCase().includes("ya existe") || 
        ...
        setMensajeError("Error al crear la marca. Por favor, intenta nuevamente.");
      }
    } finally {
      setLoading(false);
    }
