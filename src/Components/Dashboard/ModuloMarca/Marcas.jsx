    ...
    <div className="px-8 py-4 transition-all duration-300 max-sm:px-4 max-sm:py-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 max-sm:gap-5 max-sm:mb-8">
        ...
        <div className="flex justify-center sm:justify-end">
          <Tooltip text="Registrar una nueva marca" inline position="bottom-end">
            <button
      ...
      <div className="mb-4 flex flex-col sm:flex-row flex-wrap gap-3 max-sm:gap-4 max-sm:mb-6">
        <Tooltip text="Busca marcas por nombre" className="relative flex-1 min-w-[180px] max-sm:min-w-full">
        ...
        <div className="flex gap-3 w-full sm:w-auto max-sm:flex-col max-sm:gap-4">
          <Tooltip text="Muestra solo marcas activas o inactivas" position="top-end" className="flex-1 min-w-[150px] max-sm:min-w-full">
            <select
              value={filtroActivo}
          ...
          <th className="py-2 px-3 text-center w-[24%]">Acciones</th>
            ...
            <tbody>
              {marcas.map((m) => (
                ...
                >
                  <td className="py-2 px-3 text-center text-gray-600 dark:text-gray-400 max-sm:py-4">{m.id}</td>
                  <td className="py-2 px-3 text-left font-medium dark:text-white max-sm:py-4">{m.nombre}</td>
                  ...
                  <td className="px-3 text-center max-sm:py-4">
                    <div className="flex justify-center items-center gap-2">
                      <Tooltip text="Ver detalles" inline>
                        <button
                          onClick={(e) => { e.stopPropagation(); setModalDescripcion(m); }}
                      ...
                      <Tooltip text="Editar marca" inline>
                        <button
                          onClick={(e) => { e.stopPropagation(); handleEditar(m); }}
                      ...
                      <Tooltip text="Eliminar marca" inline>
                        <button
      ...
      <EditarMarca
        ...
        onClose={() => { setModalEditar(false); setMarcaSeleccionada(null); }}
      ...
      <HelpPanel
        ...
        title={helpContent.marcas.title}
        sections={helpContent.marcas.sections}
      />
    </div>
  );
}
