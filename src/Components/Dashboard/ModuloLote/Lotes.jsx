...
import { Search, X, Trash2, Edit, Eye, Package } from "lucide-react";
...
const formatearCantidad = (cantidad, tipoVenta) => {
  ...
  if (tipoVenta === "PESO") {
    // Muestra coma en lugar de punto y evita ceros innecesarios
        ...
        >
          ...
          <td className="py-2 px-3 text-center max-sm:py-4">
            <div className="flex justify-center items-center gap-2">
              {/* Ver */}
              <button onClick={(e) => { e.stopPropagation(); handleVer(lote); }} className="p-2 rounded-lg bg-emerald-500 hover:bg-emerald-600 dark:bg-emerald-600 dark:hover:bg-emerald-800 text-white transition-all hover:shadow-md active:scale-95 focus:outline-none cursor-pointer">
                <Eye className="w-4 h-4 pointer-events-none" />
              </button>
              {/* Editar */}
              <button onClick={(e) => { e.stopPropagation(); handleEditar(lote); }} className="p-2 rounded-lg bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white transition-all hover:shadow-md active:scale-95 focus:outline-none cursor-pointer">
                <Edit className="w-4 h-4 pointer-events-none" />
              </button>
              {/* Eliminar */}
              <button onClick={(e) => { e.stopPropagation(); handleEliminar(lote); }} className="p-2 rounded-lg bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white transition-all hover:shadow-md active:scale-95 focus:outline-none cursor-pointer">
